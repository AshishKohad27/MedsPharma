...
export default function Productdetails(params) {
    ...
    const { isAuth, tokenDetails, errorMessage } = useSelector(state => state.user);
                        ...
                        <Flex gap={10} direction={{ base: "column", md: "row" }}>
                            ...
                            <Box p={4}>
                                ...
                                <Button mt='6' onClick={() => {
                                    ...
                                    dispatch(addItemCart({ productId: data._id, quantity, userId: tokenDetails && tokenDetails._id }))
